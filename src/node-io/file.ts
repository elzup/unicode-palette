...
import { generateSvgString, generateScriptTilesSvg, type TileOptions } from '../render'

export function renderSvgToFile(outPath: string, options: GridOptions = {}): void {
...
export function renderScriptTilesToFile(outPath: string, options: TileOptions = {}): void {
